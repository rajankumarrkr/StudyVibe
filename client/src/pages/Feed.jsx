    ...
    return (
        <div className="relative">
            ...
            <div className="fixed top-0 left-0 right-0 p-6 z-20 flex justify-between items-center pointer-events-none">
                <h2 className="text-xl font-black text-white pointer-events-auto">For You</h2>
                <button className="w-10 h-10 rounded-full glass-card border-none flex items-center justify-center text-white pointer-events-auto">
                    <Search size={20} />
                </button>
            </div>
            ...
            >
                ...
                {!loading && questions.length === 0 && (
                    <div className="reel-item flex items-center justify-center text-white/30 px-12 text-center">
                        <div>
